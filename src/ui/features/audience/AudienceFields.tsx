...
export type AudienceMusicianOption = {
  id: string;
  name: string;
  partNames?: string[];
};
...
type Candidate =
  | (AudienceGroupOption & { audienceKind: 'group' })
  | (AudienceMusicianOption & { audienceKind: 'musician' });
...
export function AudienceFields({
  ...
  disabled = false,
  title = 'Participantes',
  searchPlaceholder = 'Buscar grupos ou músicos',
  emptySelectedLabel = 'Nenhum grupo ou músico associado.',
}: AudienceFieldsProps) {
