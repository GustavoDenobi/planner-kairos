-- Replace CPF/education with contact fields on musicians.
...
BEGIN
  ...
  INSERT INTO musicians (organization_id, full_name, user_id, email)
  VALUES (v_invite.organization_id, v_profile.display_name, v_user_id, v_profile.email)
